...
{
    public class AgendamentoMessageQueue : IAgendamentoMessageQueue, IDisposable
    {
        private readonly ILogger<AgendamentoMessageQueue> _logger;
        ...
        public AgendamentoMessageQueue(ILogger<AgendamentoMessageQueue> logger)
        {
            _logger = logger;
            ConnectRabbitMQ();
        }
        ...
        private void EnsureNotDisposed()
        {
            if (_disposed)
            {
                throw new ObjectDisposedException(nameof(AgendamentoMessageQueue));
            }
        }
